...
import com.example.shmack.Controller.App
import com.example.shmack.Utilities.*
...
object AuthService {
    ...
    fun registerUser(email: String, password: String, complete: (Boolean) -> Unit) {
        ...
        val registerRequest = object : StringRequest(Method.POST, URL_REGISTER, Response.Listener {
            ...
            error -> Log.d("ERROR", "Couldn't register the user: $error")
            complete(false)
        }) {
    ...
    fun loginUser(email: String, password: String, complete: (Boolean) -> Unit) {
        ...
        val loginRequest = object : JsonObjectRequest(Method.POST, URL_LOGIN, null, Response.Listener {
            ...
            try {
                ...
                Response.ErrorListener {
                //this is where we deal with our our errors

                        error -> Log.d("ERROR", "Couldn't login user: $error")
                    complete(false)
        })  {
